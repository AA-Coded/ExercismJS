...
export function remainingMinutesInOven(actualMinutesInOven) {
  let numOfMinsRemaining = EXPECTED_MINUTES_IN_OVEN - actualMinutesInOven;
  return numOfMinsRemaining;
}
...
export function preparationTimeInMinutes(numberOfLayers) {
  const TOTAL_PREP_TIME = PREPARATION_MINUTES_PER_LAYER * numberOfLayers;
...
export function totalTimeInMinutes(numberOfLayers, actualMinutesInOven) {
  ...
  const TOTAL_WORKING_TIME = totalPrepTime + actualMinutesInOven;
